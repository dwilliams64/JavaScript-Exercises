...
const { music: {traditional}, music: {jazz} } = recommendations;

console.log(traditional);

console.log(jazz);

const getMusicVenues = ({ music: {traditional}, music: {jazz} }) => console.log(`${traditional} and ${jazz} are good places to fuck.`);
